...
<html lang="en">
    ...
    <body class="text-gray-800 flex flex-col justify-between min-h-screen bg-white leading-normal font-sans">
            ...
            <div class="container flex items-center max-w-3xl mx-auto">
                <div class="flex items-center">
                    <a href="/" title="{{ $page->siteName }} home" class="inline-flex items-center border-0">
                        <h1 class="text-xl text-gray-900 font-normal hover:text-blue-400 my-0">{{ $page->siteName }}</h1>
                    </a>
                </div>
