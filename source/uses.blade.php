...
@section('body')
    ...
    <ul class="mt-3">
        <li><strong>Computer</strong>: 15" MacBook Pro
            <ul>
                <li>Early 2013</li>
                <li>2.4 GHz Quad-Core Intel Core i7</li>
                <li>8 GB 1600 MHz DDR3</li>
                <li>256 GB Storage</li>
            </ul>
        </li>
        <li><strong>Desk</strong>: <a href="https://www.bushbusinessfurniture.com/OurFurniture/ShopbyCollection/BushBusinessFurnitureCollections/SeriesC.aspx?pf=140&ProductSKU=SRC071MASU&Finish=Mahogany">Bush Business Furniture Series C</a></li>
        ...
        <li><strong>Monitor</strong>: <a href="https://www.vizio.com/e320fib2.html">Vizio E320fi-B2</a></li>
    ...
    <ul class="mt-3">
        ...
        <li><a href="https://matthewpalmer.net/vanilla/" target="_blank">Vanilla</a></li>
