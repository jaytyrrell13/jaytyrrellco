...
@section('body')
    ...
    <ul class="mt-3">
        ...
        <li><strong>Laptop</strong>: 15" MacBook Pro
            <ul>
                <li>Early 2013</li>
        ...
        <li><strong>USB C Hub</strong> (for work laptop): <a href="https://www.amazon.com/gp/product/B07QQ11BP6/ref=ppx_yo_dt_b_asin_title_o01_s00?ie=UTF8&psc=1" target="_blank">Vava 8-in-1 Adapter</a></li>
